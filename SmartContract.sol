...
// basic NFT minting Smart contract
// this is not payable
...
contract SmartContract is ERC721, Ownable {
    ...
    constructor(uint256 totalSupply) ERC721("SmartContract", "MC"){
    ...
    // onlyOwner()  can be added to limit who uses the function. 
    
    //Anyone can create an NFT with this one 
